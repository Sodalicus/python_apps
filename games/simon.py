...
class Button(Wrapper):
    ...
    red_bmp = (games.load_image("simon_media/red_off.bmp"),
              games.load_image("simon_media/red_on.bmp"),
              games.load_sound("simon_media/red.wav"))
    green_bmp = (games.load_image("simon_media/green_off.bmp"),
              games.load_image("simon_media/green_on.bmp"),
              games.load_sound("simon_media/green.wav"))
    blue_bmp = (games.load_image("simon_media/blue_off.bmp"),
              games.load_image("simon_media/blue_on.bmp"),
              games.load_sound("simon_media/blue.wav"))
...
class Instrumental(Wrapper):
    ...
    guitar = (games.load_image("simon_media/guitar.bmp", transparent = False),
            games.load_image("simon_media/guitar_inv.bmp", transparent = False),
            games.load_sound("simon_media/guitar.wav"))

    drums = (games.load_image("simon_media/drums.bmp", transparent = False),
            games.load_image("simon_media/drums_inv.bmp", transparent = False),
            games.load_sound("simon_media/drums.wav"))

    hat = (games.load_image("simon_media/hat.bmp", transparent = False),
            games.load_image("simon_media/hat_inv.bmp", transparent = False),
            games.load_sound("simon_media/hat.wav"))
